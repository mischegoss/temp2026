// ServiceBlueprinting Learning Paths Data
// Location: /src/components/ServiceBlueprinting/data/LearningPathsServiceBlueprinting.js
...
export const learningPaths = [
  ...
  },
  {
    ...
    description:
      'An intermediate learning path designed for all Resolve users. Master the essential skills needed to design effective technical blueprints.',
    link: '',
    icon: '🔰',
    extendedDescription:
