...
/**
 * ProspectNeedHelp component - Creates a static help section matching the Welcome Section
 * @returns {JSX.Element} ProspectNeedHelp component
 */
const ProspectNeedHelp = ({ style = {} }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Ready to dive into Resolve Actions? Contact Us for more information.
        </p>

        {/* Divider under paragraph - using professional blue gradient */}
        <div
          style={{
            width: '100px',
            height: '3px',
            background:
              'linear-gradient(to right, rgba(0, 80, 199, 0.3), var(--brand-blue), rgba(0, 80, 199, 0.3))',
            borderRadius: '1.5px',
            margin: '0 0 2rem 0',
        ...
        >
          <a
            ...
            style={{
              ...
              transition: 'all 0.3s ease-in-out',
              border: `2px solid ${
                isButtonHovered ? 'var(--brand-blue-400)' : 'var(--brand-blue)'
              }`,
...
export default ProspectNeedHelp
