...
/**
 * HomeNeedHelp component - Creates a static help section without button
 * @returns {JSX.Element} HomeNeedHelp component
 */
const HomeNeedHelp = ({ style = {} }) => {
  ...
  return (
    <section
      className='home-need-help-section'
      style={mergedStyles}
